    ...
    if (file) {
      try {
        ...
        const resFile = await axios({
          ...
          headers: {
            pinata_api_key: `
            d2d615c0720767d9f956`,
            pinata_secret_api_key: `
            9337ccfbacd506ff1e189d462b9d0aeeed7c527793755bc3805cc68063f8dbcb`,
            "Content-Type": "multipart/form-data",
          },
        });
        const ImgHash = `https://red-electrical-rabbit-583.mypinata.cloud/ipfs/${resFile.data.IpfsHash}`;
        console.log(ImgHash);
